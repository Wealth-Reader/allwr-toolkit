...
GitHub's private vulnerability reporting channel on this repository (marked
as a conduct report) or by direct message to a maintainer listed in
MAINTAINERS.md. All complaints will be reviewed and investigated promptly and
...
1. **Correction** - a private, written warning, with clarity of violation.
